 ...
 * @param options used to specify global and fixture setup and teardowns:
...
// Nodeunit swallows exceptions sometimes. By "catching" them here and rethrowing, they show up if they kill a test.
 ...
 * @param testMethods one of three things:
...
/**
 * Ends a test
 * @param test the test being ended
 * @private
 */
 ...
 * it is "disarmed".
 * @param delay how long until the timebomb executes its callback.
 * @param callback function to execute when the timebomb "explodes"
 * @constructor
 */
